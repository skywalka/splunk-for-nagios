...
try:
    ...
    for r in results:
		...
		if data2:
		    ...
		    s.close()
		    liveservicewarningind = int(liveservices[0])
		    liveservicetotalind = int(liveservices[1])
		    liveservicewarning = liveservicewarning + liveservicewarningind
		    liveservicetotal = liveservicetotal + liveservicetotalind
                r["liveservicewarningstatus"] = liveservicewarning
