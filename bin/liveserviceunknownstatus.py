...
try:
    ...
    for r in results:
		...
		if data2:
		    ...
		    s.close()
		    liveserviceunknownind = int(liveservices[0])
		    liveservicetotalind = int(liveservices[1])
		    liveserviceunknown = liveserviceunknown + liveserviceunknownind
		    liveservicetotal = liveservicetotal + liveservicetotalind
                r["liveserviceunknownstatus"] = liveserviceunknown
