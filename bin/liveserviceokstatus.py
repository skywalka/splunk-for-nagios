# Script to request services with OK status and total services by accessing MK Livestatus
        ...
        if "_raw" in r:
			...
			s = None 
			    ...
			    if data2:
			        ...
			        s.close()
			        liveservicesupind = int(liveservices[0])
			        liveservicestotalind = int(liveservices[1])
			        liveservicesup = liveservicesup + liveservicesupind
			        liveservicestotal = liveservicestotal + liveservicestotalind
                        r["liveserviceokstatus"] = liveservicesup
